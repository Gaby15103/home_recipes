...
FROM users u
         JOIN roles r
              ON (u.username='user1' AND r.name='USER')
...
VALUES ('Breakfast'),('Lunch'),('Dinner'),('Dessert'),('Vegetarian')
RETURNING id, name;
...
INSERT INTO ingredients (name) VALUES
                                   ('Flour'),('Eggs'),('Milk'),('Cheese'),('Tomato'),('Lettuce'),('Chicken'),('Chocolate'),('Pasta'),('Vegetables')
RETURNING id, name;

-- ----------------------
-- INGREDIENT GROUPS
-- ----------------------
-- Example: one group per recipe
